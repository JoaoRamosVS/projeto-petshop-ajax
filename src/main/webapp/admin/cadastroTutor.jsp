...
<head>
    <meta charset="UTF-8">
    <title>Petshop - Cadastro de Novo Tutor</title>
...
<div class="container">
    ...
    <h1>Cadastro de Novo Tutor</h1>
    
    <div id="message" style="display:none;"></div>

    <form id="cadastroTutorForm">
        ...
        <button type="submit"><i class="fas fa-save"></i> Cadastrar Tutor</button>
    </form>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#cadastroTutorForm').submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: '<%= request.getContextPath() %>/TutorController?action=createSimple',
                type: 'POST',
                ...
                success: function(response) {
                    ...
                    $('#cadastroTutorForm')[0].reset();
                    
                    setTimeout(function() {
                         window.location.href = '<%= request.getContextPath() %>/admin/gerenciarTutor.jsp';
                    }, 2000);
                },
                error: function(xhr) {
